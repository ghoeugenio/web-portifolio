...
export const About = () => {
  ...
  useEffect(() => {
    colorMode === "light" ? setColor("primaryDark") : setColor("alterPrimary");
  }, [colorMode]);
  ...
  return (
    <Box bgGradient="linear(to-b, primaryDark, primary)">
      <Box
        ...
        maxHeight={isOpen ? "100rem" : !isMobile ? "15rem" : "30rem"}
        overflow={isOpen && isMobile ? "none" : "hidden"}
      >
        <Image
          src={Profile}
          w={isMobile ? "12rem" : "12rem"}
          h={isMobile ? "12rem" : "12rem"}
        ...
        <Box ml="2rem">
          ...
          <Box transition="text 0s opacity" pb="1rem">
            {!isOpen && (
              <Button
                onClick={onToggle}
